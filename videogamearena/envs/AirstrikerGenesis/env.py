...
class AirstrikerGenesisEnv:
    """A simplified environment for Airstriker-Genesis with stable-retro."""
    ...
    def _skip_title_screen(self):
        ...
        for _ in range(10):  # Press Start to bypass intro
    ...
    def get_action_instructions(self):
        ...
        return """
Action format: Use [x] format, e.g., [r][f] or [rf] for simultaneous inputs.
...
#     obs = env.reset()
#     for _ in range(100):
#         obs, done, info = env.step("[r][f]")  # Move right + fire
#         env.render()
#         if done:
#             break
#     env.close()